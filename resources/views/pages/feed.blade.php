                ...
                <div class="bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-200">
                    ...
                    <div class="px-4 pb-4 -mt-12">
                        <a href="{{ route('pages.profile.show') }}" class="block">
                            ...
                            {{-- User Info --}}
                            <div class="space-y-1">
                                <h2 class="text-xl font-bold text-gray-900 hover:text-primary transition-colors">
                                    {{ $user->name }}
                                </h2>
                    ...
                    <div class="px-4 pb-4 -mt-12">
                        ...
                        <div class="mt-4 space-y-2">
                            <a href="{{ route('register') }}" 
                               class="block w-full px-4 py-2 bg-primary text-white text-center text-sm font-medium rounded-lg hover:opacity-90 transition-colors">
                                Sign Up
                            </a>
                            <a href="{{ route('login') }}" 
                               class="block w-full px-4 py-2 text-center text-sm font-medium text-primary hover:opacity-80 transition-colors">
                    ...
                    <a href="{{ route('feed.following') }}" 
                       class="flex-1 px-6 py-3 text-center font-medium transition-all duration-200 border-b-2 
                        ...
                        <div class="flex items-center justify-center gap-2">
                            ...
                            <span>Show following posts</span>
                        </div>
                    </a>
                </div>
            </div>
                    ...
                    <div class="bg-white border border-gray-200 rounded-lg p-12 shadow-sm text-center">
                        ...
                        @if(($feedType ?? 'all') === 'following')
                            ...
                            <a href="{{ route('search.show') }}" 
                               class="inline-flex items-center gap-2 px-4 py-2 bg-primary text-white rounded-lg hover:opacity-90 transition-colors">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden">
                        ...
                        <a href="{{ route('albums.show', $album) }}" 
                           class="block p-3 hover:bg-gray-50 transition-colors duration-150 group">
                            <div class="flex gap-3">
                                ...
                                {{-- Album Info --}}
                                <div class="flex-1 min-w-0">
                                    <h4 class="text-sm font-medium text-gray-900 truncate group-hover:text-primary transition-colors">
                                        {{ $album->title }}
                                    </h4>
                    ...
                    <div class="px-4 py-2 bg-gray-50 border-t border-gray-200">
                        <a href="{{ route('albums.index') }}" 
                           class="text-xs text-primary hover:opacity-80 font-medium flex items-center justify-center gap-1">
                            Show more
                        </a>
                    </div>
                </div>
                                ...
                                <div class="flex-shrink-0">
                                    ...
                                    @else
                                        <form action="{{ route('users.follow', $suggestedUser) }}" method="POST" class="inline">
                                            @csrf
                                            <button type="submit"
                                                    class="px-3 py-1 text-xs font-medium bg-primary text-white rounded-full hover:opacity-90 transition-colors">
                                                Follow
                                            </button>
                                        </form>
                                    @endif
