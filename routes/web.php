...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('auth')->group(function () {
        Route::delete('profile', [DeleteAccountController::class, 'destroy'])
...
Route::middleware(['auth', 'admin'])
    ...
    ->group(function () {
        ...
        Route::get('groups/{group}/edit', [GroupController::class, 'adminEdit'])
            ->name('groups.edit');

        Route::put('groups/{group}', [GroupController::class, 'update'])
            ->name('groups.update');

        Route::get('groups/{group}/requests', [GroupController::class, 'adminRequests'])
            ->name('groups.requests');

        Route::get('groups/{group}/members', [GroupController::class, 'adminMembers'])
            ->name('groups.members');
